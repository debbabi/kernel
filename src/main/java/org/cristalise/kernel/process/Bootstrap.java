...
public class Bootstrap
{
     ...
     * @throws Exception
     */
    public static DomainPath verifyResource(String ns, String itemName, int version, String itemType, Set<Outcome> outcomes, boolean reset)
            throws Exception
    {
                    ...
                    throws Exception
    {
        ...
        Logger.msg(1, "Bootstrap.verifyResource() - Verifying version:'" + version + "' type:'" + typeImpHandler.getName() + "' name:'" + itemName+"'");
        ...
        if( en.hasNext() ) {
            Logger.msg("Bootstrap.verifyResource() - Found type:'" + typeImpHandler.getName() + "'name:'" + itemName + "'.");
            ...
            Logger.msg("Bootstrap.verifyResource() - Not found type'" + typeImpHandler.getName() + "' name:'" + itemName + "'. Creating new.");
        ...
        for (Outcome newOutcome : outcomes) {
            if( checkToStoreOutcomeVersion(thisProxy, newOutcome, version, reset) ) {
                ...
                if (ns != null) {
                    String error = OutcomeValidator.getValidatorForOutcome(newOutcome).validate(newOutcome.getData());
    ...
    private static ItemProxy verifyPathAndModuleProperty(String ns, String itemType, String itemName, ItemPath itemPath,
                                                         DomainPath modDomPath, DomainPath path)
            throws Exception
    {
            ...
            throws PersistencyException
    {
        ...
        int eventID = hist.addEvent( systemAgents.get("system").getPath(), "Admin", "Bootstrap", "Bootstrap", "Bootstrap", 
                newOutcome.getSchemaType(), 0, "PredefinedStep", 0, transDone, viewName
                ).getID();
    ...
    {
        try {
            Viewpoint currentData = (Viewpoint) item.getObject(ClusterStorage.VIEWPOINT + "/" + newOutcome.getSchemaType() + "/" + version);
            ...
            Logger.msg("Bootstrap.checkToStoreOutcomeVersion() - Item:" + item.getPath() + "Schema:" + newOutcome.getSchemaType() + " version:" + version + " not found! Attempting to insert new.");
        }
        return true;
    }
